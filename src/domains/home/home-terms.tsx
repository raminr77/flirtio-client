  ...
  return (
    <section id={HOME_MENU.TERMS} className='w-full h-screen flex flex-col items-center justify-center relative'>
      ...
      >
        ...
        <p>FLIRTIO is provided "as is" without any warranties, express or implied. We are not responsible for any direct, indirect, incidental, or consequential damages resulting from your use of the service. We may update these terms from time to time. Any changes will be posted on this page, and your continued use of FLIRTIO signifies your acceptance of the updated terms.</p>
        <p>If you have any questions or concerns about these terms, please contact us at - info [at] raminrezaei.ir. By using FLIRTIO, you acknowledge that you have read, understood, and agree to these terms and conditions.</p>
